...
const Hero = (props: Props) => {
    return (
        <motion.section
            ...
            className='flex justify-center relative clip-path-polygon-[0_0,_100%_0,_100%_100%,_70%_95%,_0_100%] h-[820px] lg:h-[510px] py-24 z-[1]'>
...
// <div div className = 'absolute flex justify-end top-0 right-0 bottom-0 left-0 w-full h-full overflow-hidden' >
//     <HeroBgAnimation />
//         </div >